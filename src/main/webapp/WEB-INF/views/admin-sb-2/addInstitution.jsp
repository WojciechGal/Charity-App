        ...
        <li class="nav-item active">
            ...
            <div id="collapseInst" class="collapse show" aria-labelledby="headingInst" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="/admin/addInstitution">Dodaj nową</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Dodawanie nowych instytucji</h1>
                <p class="mb-4">Dodaj zaufaną instytucję, na poczet której będzie można oddawać paczki z nieużywanymi rzeczami.</p>
